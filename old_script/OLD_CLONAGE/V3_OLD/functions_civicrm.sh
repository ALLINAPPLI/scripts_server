...
updateCivicrm(){ 
  ...
  [ $cms_instance == "standalone" ] && rm -rf core && mv temp_civi_standalone/web/core $vhosts/$civi_folder/httpdocs && rm -rf temp_civi_standalone 

  # plesk repair fs $civi_folder -y
  ...
  plesk repair fs $civi_folder -y && echo -e ">> [${GREEN}REUSSI${NC}] Plesk repair réussi"
