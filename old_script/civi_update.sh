...
################################################
##
##  Mise à jour de CiviCRM pour les instances web
##
################################################
...
[ $cms_instance == "wordpress" ] && [ -e $chemin_plugins_wordpress/civicrm/civicrm.php ] && echo "La version actuelle du code de CiviCRM est : $versionCIVI_WP" 
[ $cms_instance == "drupal" ] && [ -e $chemin_plugins_drupal/civicrm/xml/version.xml ] && echo "La version actuelle du code de CiviCRM est : $versionCIVI_DRUPAL" 
[ $cms_instance == "standalone" ] && [ -e $chemin_plugins_standalone/core/xml/version.xml ] && echo "La version actuelle du code de CiviCRM est : $versionCIVI_STANDALONE" 
